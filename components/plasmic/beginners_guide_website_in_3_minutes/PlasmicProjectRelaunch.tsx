...
import sty from "./PlasmicProjectRelaunch.module.css"; // plasmic-import: puRdkqAH60H7/css
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          <Stack__
            as={"section"}
            hasGap={true}
            className={classNames(projectcss.all, sty.section__x1LQk)}
            id={"Services"}
          >
            <PlasmicImg__
              alt={""}
              className={classNames(sty.img__mLxdq)}
              displayHeight={"700px"}
          ...
          <Stack__
            as={"section"}
            hasGap={true}
            className={classNames(projectcss.all, sty.section__xdONs)}
            id={"work"}
          >
            <div className={classNames(projectcss.all, sty.freeBox__sXfeg)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__pbjY9)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__eoj4Q)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <Stack__
              as={"section"}
              hasGap={true}
              className={classNames(projectcss.all, sty.section__rvF9N)}
              id={"about"}
            >
              <div className={classNames(projectcss.all, sty.freeBox__uQoBn)}>
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__aOwkY)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
                ...
                <Stack__
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.columns__mqhuU)}
                >
                  <div
                    className={classNames(projectcss.all, sty.column__d28YO)}
                  >
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img___7Scj)}
                      displayHeight={
                  ...
                  <div className={classNames(projectcss.all, sty.column__jv4R)}>
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img__ngeXp)}
                      displayHeight={
                        hasVariant(globalVariants, "screen", "mobileOnly")
                          ? "300px"
                          : "600px"
              ...
              <div className={classNames(projectcss.all, sty.freeBox__apkHd)}>
                <h3
                  className={classNames(
                    projectcss.all,
                    projectcss.h3,
            ...
            <Stack__
              as={"section"}
              hasGap={true}
              className={classNames(projectcss.all, sty.section___1Obpa)}
              id={"about"}
            >
              <div className={classNames(projectcss.all, sty.freeBox__aTBli)}>
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__ueXed)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
              ...
              <div className={classNames(projectcss.all, sty.freeBox__utSf)}>
                <h3
                  className={classNames(
                    projectcss.all,
                    projectcss.h3,
            ...
            <Stack__
              as={"section"}
              hasGap={true}
              className={classNames(projectcss.all, sty.section__l1Kwz)}
              id={"contact"}
            >
              <div className={classNames(projectcss.all, sty.freeBox__pIghs)}>
                <h2
              ...
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.columns__e14Ne)}
              >
                <div className={classNames(projectcss.all, sty.column__qih1S)}>
                  <ProjectCard
                    className={classNames(
                      "__wab_instance",
                      sty.projectCard__ed36Z
                    )}
                    image={{
                ...
                <div className={classNames(projectcss.all, sty.column__eOMl)}>
                  <ProjectCard
                    className={classNames(
                      "__wab_instance",
                      sty.projectCard__fmqc6
                    )}
