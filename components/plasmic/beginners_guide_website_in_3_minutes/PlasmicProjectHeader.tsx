...
import sty from "./PlasmicProjectHeader.module.css"; // plasmic-import: LISFaI3BvO-Q/css
...
function PlasmicProjectHeader__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.columns__fgAvf)}>
        <div className={classNames(projectcss.all, sty.column__bFxM8)}>
          <div
            className={classNames(
              projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.column__lBu8J)}>
          <div className={classNames(projectcss.all, sty.columns___5QJx)}>
            <div className={classNames(projectcss.all, sty.column__y6Yt)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__tcRk7)}>
                {renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.column__gwzNs)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__fgyRj)}>
                {renderPlasmicSlot({
